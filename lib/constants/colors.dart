...
MaterialColor hintTextColor = createMaterialColor(Color(0xFF696969));
MaterialColor textColor = createMaterialColor(Color(0xFFECECEC));
MaterialColor greenColor = createMaterialColor(Color(0xFF1DB954));
MaterialColor whiteColor = createMaterialColor(Color(0xFFFFFFFF));
